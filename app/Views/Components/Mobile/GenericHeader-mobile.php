<nav class="level navbar is-light is-fixed-top has-shadow" role="navigation" aria-label="main navigation">
  <div class="level-left navbar-brand">
    <a class="navbar-item" href="/home">
      <img src="../../img/Camagru-transp-long5.png" alt="Home"><a class="navbar-item">Browse</a>
    </a>
    <script>
      window.burgerMenu();
    </script>
  ...
  <div id="navbarMenu" class="level-right navbar-menu">
    ...
    <div class="navbar-end">
      <input class="navbar-item input" type="text" name="searchQuery" placeholder="Search for posts..." style="max-width: 90%; padding: 1rem; margin: .5rem;" />
