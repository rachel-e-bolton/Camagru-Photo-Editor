<div class="modal-card">
    <header class="modal-card-head">
      <p class="modal-card-title is-family-primary">Terms of Use</p>
    </header>
    <section class="modal-card-body is-family-secondary">
        Last updated: 05 November 2019
        <br/><br/>  
        Please read these Terms of Use ("Terms", "Terms of Use") carefully before using the http://localhost:8080 <i>Camagru</i> website and the <i>Camagru</i> mobile
        application (the "Service") operated by Glen Wasserfall and Rachel Bolton ("us", "we", or "our").
        <br/><br/> 
        ...
        post your content, you grant Glen Wasserfall and Rachel Bolton non-exclusive, royalty-free and irrevocable right to use, reproduce, 
        ...
        by Glen Wasserfall and Rachel Bolton.
        Glen Wasserfall and Rachel Bolton have no control over, and assume no responsibility for, the content,
        privacy policies, or practices of any third party web sites or services. You further acknowledge and
        agree that Glen Wasserfall and Rachel Bolton shall not be responsible or liable, directly or indirectly, for any
